...
function ensureForwardCompatibleColumns(database: DatabaseSync) {
  ...
  for (const alter of [
    ...
    `ALTER TABLE nodes ADD COLUMN acme_ca_provider TEXT`,
    `ALTER TABLE nodes ADD COLUMN acme_ca_url TEXT`,
    ...
    `ALTER TABLE nodes ADD COLUMN hy2_auto_update_enabled INTEGER NOT NULL DEFAULT 1 CHECK(hy2_auto_update_enabled IN (0,1))`,
    ...
    `ALTER TABLE nodes ADD COLUMN server_bandwidth_up_mbps INTEGER NOT NULL DEFAULT 0`,
    `ALTER TABLE nodes ADD COLUMN server_bandwidth_down_mbps INTEGER NOT NULL DEFAULT 0`,
    `ALTER TABLE nodes ADD COLUMN ignore_client_bandwidth INTEGER NOT NULL DEFAULT 0 CHECK(ignore_client_bandwidth IN (0,1))`,
    `ALTER TABLE nodes ADD COLUMN quic_init_stream_receive_window INTEGER`,
    `ALTER TABLE nodes ADD COLUMN quic_max_stream_receive_window INTEGER`,
    `ALTER TABLE nodes ADD COLUMN quic_init_conn_receive_window INTEGER`,
    `ALTER TABLE nodes ADD COLUMN quic_max_conn_receive_window INTEGER`,
    `ALTER TABLE nodes ADD COLUMN quic_max_idle_timeout_seconds INTEGER`,
    `ALTER TABLE nodes ADD COLUMN quic_max_incoming_streams INTEGER`,
    `ALTER TABLE nodes ADD COLUMN quic_disable_path_mtu_discovery INTEGER NOT NULL DEFAULT 0 CHECK(quic_disable_path_mtu_discovery IN (0,1))`,
    `ALTER TABLE nodes ADD COLUMN congestion_type TEXT`,
    `ALTER TABLE nodes ADD COLUMN congestion_bbr_profile TEXT`,
...
function migrate(database: DatabaseSync) {
  ...
  database.exec(`
    ...
    CREATE TABLE IF NOT EXISTS nodes (
      ...
      hy2_auto_update_enabled INTEGER NOT NULL DEFAULT 1 CHECK(hy2_auto_update_enabled IN (0,1)),
      ...
      server_bandwidth_up_mbps INTEGER NOT NULL DEFAULT 0,
      server_bandwidth_down_mbps INTEGER NOT NULL DEFAULT 0,
      ignore_client_bandwidth INTEGER NOT NULL DEFAULT 0 CHECK(ignore_client_bandwidth IN (0,1)),
      quic_init_stream_receive_window INTEGER,
      quic_max_stream_receive_window INTEGER,
      quic_init_conn_receive_window INTEGER,
      quic_max_conn_receive_window INTEGER,
      quic_max_idle_timeout_seconds INTEGER,
      quic_max_incoming_streams INTEGER,
      quic_disable_path_mtu_discovery INTEGER NOT NULL DEFAULT 0 CHECK(quic_disable_path_mtu_discovery IN (0,1)),
      congestion_type TEXT,
      congestion_bbr_profile TEXT,
